...
from .prop.properties import SAObjectSettings
DO = False  # Debug out
...
def read(context: bpy.types.Context,
	...
	if isArmature:
		...
		armatureObj.saObjflags.fromDictionary(root.objFlags)
		...
		for b in bones:
			...
			bone.head = (0, 0, 0)
			bone.tail = (1, 0, 0)
			bone.saObjflags.fromDictionary(b.objFlags)
		...
		for o in objects:
			...
			bpyObj.saObjflags.fromDictionary(o.objFlags)
