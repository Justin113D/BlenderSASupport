        ...
        for o in objects:
            if o.origObject.type == 'MESH':
                if o.saProps["isCollision"]:
                    cObjects.append(o)
                if not o.saProps["isCollision"] \
                        or o.saProps["isCollision"] \
...
def sortChildren(cObject: bpy.types.Object,
    ...
    if cObject.type == 'MESH':
        if lvl and fmt != 'SA1' \
                and cObject.saSettings.isCollision \
            ...
            visible = True if not cObject.saSettings.isCollision \
            ...
            model = ModelData(cObject,
                              ...
                              cObject.name,
                              export_matrix,
                              cObject.saSettings.isCollision,
                              visible)
...
class Col:
    ...
    def read(cls,
        ...
        if SA2:
            ...
            saProps["isCollision"] \
                = bool((f & SA2SurfaceFlags.collision.value) & 0xFFFFFFFF)
            ...
            saProps["standOnSlope"] \
                = bool(f & SA2SurfaceFlags.StandOnSlope.value)
            ...
            saProps["isCollision"] \
                = bool((f & SA1SurfaceFlags.collision.value) & 0xFFFFFFFF)
            ...
            saProps["noAcceleration"] \
                = bool(f & SA1SurfaceFlags.NoAcceleration.value)
            saProps["increasedAcceleration"] \
